...
.file-cta:focus,
.file-name:focus, .file-cta:focus-visible,
.file-name:focus-visible, .file-cta:focus-within,
.file-name:focus-within, .is-focused.file-cta,
...
[disabled].file-cta,
[disabled].file-name, fieldset[disabled] .file-cta,
