...
.input:focus, .textarea:focus, .input:focus-visible, .textarea:focus-visible, .input:focus-within, .textarea:focus-within, .is-focused.input, .is-focused.textarea, .input:active, .textarea:active, .is-active.input, .is-active.textarea {
  outline: none;
}
...
.input:active, .textarea:active, .is-active.input, .is-active.textarea {
  --bulma-input-border-l-delta: var(--bulma-input-active-border-l-delta);
}
.input:focus, .textarea:focus, .input:focus-within, .textarea:focus-within, .is-focused.input, .is-focused.textarea {
...
/*# sourceMappingURL=input-textarea.css.map */
